...
extension Nodes.Kern {
    ...
    public var zleak: NameNode<Zleak> {
        .init(oid: OID.Kern.zleak)
    }
    ...
    public var interrupt_timer_coalescing_enabled: LeafNameNode<CInt> {
        .init(oid: OID.Kern.interrupt_timer_coalescing_enabled)
    }

    public var timer_coalesce_idle_entry_hard_deadline_max: LeafNameNode<CInt> {
        .init(oid: OID.Kern.timer_coalesce_idle_entry_hard_deadline_max)
    }
...
extension Nodes.Kern {
    public struct Zleak: NodeCollection {
        ...
        public var active: LeafNameNode<CInt> {
            .init(oid: OID.Kern.Zleak.active)
        }

        public var max_zonemap_size: LeafNameNode<CLong> {
            .init(oid: OID.Kern.Zleak.max_zonemap_size)
        }

        public var global_threshold: LeafNameNode<CLongLong> {
            .init(oid: OID.Kern.Zleak.global_threshold)
        }

        public var zone_threshold: LeafNameNode<CLongLong> {
            .init(oid: OID.Kern.Zleak.zone_threshold)
        }
    }
}
